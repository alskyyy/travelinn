    ...
    <div class="d-flex flex-column justify-content-center align-items-center flex-grow-1" id="main-content">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <p class="text-center">Already have an account? <a class="text-decoration-none text-danger" href="<?php echo e(route('login')); ?>">Login</a></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\Travelin\resources\views/auth/register.blade.php ENDPATH**/ ?>