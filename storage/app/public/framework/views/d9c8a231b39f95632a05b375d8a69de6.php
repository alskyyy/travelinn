            ...
            <div class="container-fluid w-100 py-5" style="padding-left: 5%; padding-right: 5%;">
                                ...
                                <div class="row g-0 w-100">
                                    <div class="col-md-3 p-0">
                                        <div class="card-image">
                                            <?php if($place['photo_url']): ?>
                                                <img class="img-fluid rounded-start" src="<?php echo e($place['photo_url']); ?>" alt="<?php echo e($place['name']); ?>" />
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-md-9 px-2">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text"><i class="fas fa-map-marker-alt me-2"></i><?php echo e($place['address']); ?></p>
                                            <div class="rating">
                                                <?php
                                                ...
                                                <div class="score-reviews">
                                                    <p class="score"><?php echo e(number_format($place['rating'], 1)); ?></p>
                                                    <p class="reviews">
                                                        <?php
                                            ...
                                            <div class="d-flex w-100 gap-2">
                                                <form action="<?php echo e(route('bookmarks.destroyV2', ['bookmark' => $place['id']])); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <a class="btn flex-grow-1" href="<?php echo e(route('place.detail_v2', ['placeId' => $place['place_id']])); ?>" style="background-color: #8dd3bb">
                                                    View Place
                                                </a>
                                            </div>
                                        </div>
                ...
                <?php else: ?>
                    <div class="alert alert-warning text-center">
                        Please <a href="<?php echo e(route('login')); ?>">login</a> to view your bookmarks.
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\Travelin\resources\views/bookmarks.blade.php ENDPATH**/ ?>