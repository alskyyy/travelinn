...
<?php $__env->startSection('content'); ?>
    <div class="d-flex flex-column justify-content-center align-items-center flex-grow-1" id="main-content">
        <div class="mb-4">
            <img class="brand-logo img-fluid" src="<?php echo e(asset('storage/logo.png')); ?>" alt="Travelin Logo" style="max-width: 5dvw;">
        </div>
        <div class="login-container">
            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a class="text-danger text-decoration-none" href="<?php echo e(route('forgot.password')); ?>">Forgot Password</a>
                </div>
                <div class="d-grid mb-3">
                    <button class="btn btn-success border-0 text-dark fw-medium" type="submit" style="background-color: #8dd3bb">Login</button>
                </div>
                <p class="text-center">Don't have an account? <a class="text-danger text-decoration-none" href="<?php echo e(route('register')); ?>">Sign up</a></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\GitHub\Travelin\resources\views/auth/login.blade.php ENDPATH**/ ?>